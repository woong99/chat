    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/friends"
          element={
            <PrivateRoute token={accessToken} component={<FriendsPage />} />
          }
        />
        <Route
          path="/chat"
        ...
        <Route
          path="/"
          element={
            <PrivateRoute token={accessToken} component={<MainPage />} />
          }
        />
        <Route
          path="/connect-stomp"
